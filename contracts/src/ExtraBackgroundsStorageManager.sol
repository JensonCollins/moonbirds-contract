...
import {IBucketStorage} from "../solidify/IBucketStorage.sol";
import {BucketStorageLib, FieldCoordinates} from "../solidify/BucketStorageLib.sol";
import {Compressed} from "../solidify/Compressed.sol";
import {Ownable} from "@openzeppelin/contracts/access/Ownable.sol";

import {PublicInflateLibWrapper} from "../solidify/InflateLibWrapper.sol";
import {IndexedBucketLib} from "../solidify/IndexedBucketLib.sol";

import {LayerStorageMapping, LayerType} from "./gen/LayerStorageMapping.sol";
import {LayerStorageDeployer} from "./gen/LayerStorageDeployer.sol";
import {TraitStorageMapping, TraitType} from "./gen/TraitStorageMapping.sol";
import {TraitStorageDeployer} from "./gen/TraitStorageDeployer.sol";
...
contract ExtraBackgroundsStorageManager is Ownable {
     ...
     */
    function setBucketStorage(
        uint256 idx,
        IBucketStorage store
    ) external onlyOwner {
        _bundle[idx] = store;
    }
}
