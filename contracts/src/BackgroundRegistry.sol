...
import {IMoonbirds} from "contracts/lib/moonbirds-contract/contracts/IMoonbirds.sol";

import {MoonbirdAuthBase} from "./MoonbirdAuth.sol";
import {ProofBackgroundRegistry} from "./ProofBackgroundRegistry.sol";
import {IEligibilityConstraint} from "./eligibility/IEligibilityConstraint.sol";
...
contract BackgroundRegistry is MoonbirdAuthBase, Ownable {
    ...
    constructor(
        ...
        ProofBackgroundRegistry registryV1_
     ...
     */
    function getEntryWithFallback(
        uint256 tokenId
    ) public view returns (RegistryEntry memory) {
     ...
     * eligible for.
     */
    function getAllEligibleBackgrounds(
        uint256 tokenId
     ...
     */
    function isTokenEligibleForBackground(
        uint256 tokenId,
        uint96 backgroundId
     ...
     */
    function addNewBackgroundConstraint(
     ...
     */
    function _setBackgroundByOwner(
        uint256 tokenId,
        uint96 backgroundId
    ) internal {
