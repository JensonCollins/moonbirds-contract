...
library FeaturesLib {
     ...
     */
    bytes32 public constant FEATURES_ROOT =
        hex"f8b43e6d091349677b52df00d4dbec8ac3a71d9a48df3eeece013f20733e8355";
    ...
    function deserialise(
        uint256 data
    ) internal pure returns (Features memory features) {
    ...
    function deserialise(
        bytes memory data
    ) internal pure returns (Features memory) {
        if (data.length != 7) {
